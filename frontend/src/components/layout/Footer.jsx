  ...
  return (
    <footer className="bg-dark-900 border-t border-white/5 pt-12 pb-12 relative overflow-hidden mt-6">
      ...
      <div className="max-w-[1400px] mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-8">
          <div className="space-y-6">
            ...
            >
              ...
              <span className="text-neon-cyan drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">
                hub
              </span>
            </Link>
            <p className="text-gray-500 font-medium leading-relaxed mb-6">
              The definitive destination for cutting-edge mobile technology. We
              bridge the gap between today and the future.
            </p>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-neon-cyan hover:border-neon-cyan/50 hover:bg-neon-cyan/5 transition-all"
              >
                <Facebook size={20} />
              </a>
              <a
          ...
          <div>
            <h5 className="text-xs font-black uppercase tracking-[0.2em] text-neon-cyan mb-8">
              Contact Information
            </h5>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col items-center justify-center gap-6 text-center">
          <p className="text-gray-600 font-bold text-sm uppercase tracking-tighter">
            &copy; {new Date().getFullYear()}{" "}
            <a
              href="https://pramodchandima.github.io/my-portfolio/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-neon-cyan hover:text-white transition-colors duration-200 cursor-pointer"
            >
              Pramod Chandima
            </a>
            . All rights reserved.
